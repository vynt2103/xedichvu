          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                Contact newdanang.vn
              </h2>
              <p className="mb-12 text-base font-medium text-body-color">
                We are a freelance web development team based in Vietnam. Send us your project ideas, requirements, or inquiries — we will get back to you at <strong>info@newdanang.vn</strong> as soon as possible.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
